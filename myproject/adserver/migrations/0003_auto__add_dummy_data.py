...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'dummy_data'
        db.create_table('adserver_dummy_data', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('val1', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val2', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val3', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val4', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val5', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val6', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('val7', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('adserver', ['dummy_data'])


    def backwards(self, orm):
        
        # Deleting model 'dummy_data'
        db.delete_table('adserver_dummy_data')
    ...
    models = {
        ...
        'adserver.dummy_data': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'val1': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'val2': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'val3': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
