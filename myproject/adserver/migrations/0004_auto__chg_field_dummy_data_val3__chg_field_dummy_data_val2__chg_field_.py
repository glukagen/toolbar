...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'dummy_data.val3'
        db.alter_column('adserver_dummy_data', 'val3', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'dummy_data.val2'
        db.alter_column('adserver_dummy_data', 'val2', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'dummy_data.val1'
        db.alter_column('adserver_dummy_data', 'val1', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'dummy_data.val3'
        db.alter_column('adserver_dummy_data', 'val3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'dummy_data.val2'
        db.alter_column('adserver_dummy_data', 'val2', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'dummy_data.val1'
        db.alter_column('adserver_dummy_data', 'val1', self.gf('django.db.models.fields.CharField')(max_length=100))
